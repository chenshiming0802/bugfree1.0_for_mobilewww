...
EOT;
        $ErrorInfo .= "\n<div class='ErrorInfo'>\n";
        $ErrorInfo .= "<strong>ERROR OCCUR TO $_SERVER[PHP_SELF]:</strong><br />\n";
        
        if ($this->_logsql) return $this->_errorMsg;
		if (empty($this->_connectionID)) $this->_errorMsg = @mysql_error();
		else $this->_errorMsg = @mysql_error($this->_connectionID);
      
        $ErrorInfo .= $this->_errorMsg . "<br /><br />\n";
        $ErrorInfo .= "<strong>The FULL SQL IS:</strong><br />\n" . $this->_SQL . "<br />\n</div>";
   	    return $ErrorInfo;
	}
