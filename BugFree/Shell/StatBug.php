...
# File to Mail statistics of bugs of BugFree system.
# 
...
# @package     BugFree
# @version     $Id: StatBug.php,v 1.2 2005/09/01 02:16:11 wwccss Exp $
#
<?php
$ServerName  = "http://wangcs2005.okooo.com";
$BugUserName = "wangcs";
$BugUserPWD  = "123456";
file($ServerName . "/BugFree/StatBug.php?BugUserName=" . $BugUserName . "&BugUserPWD=" . $BugUserPWD);
?>