...
# @package     BugFree
# @version     $Id: NoticeBug.sh,v 1.2 2005/09/01 02:16:11 wwccss Exp $
#
ServerName="http://wangcs2005.okooo.com"
BugUserName="wangcs"
BugUserPWD="123456"
wget --spider $ServerName/BugFree/NoticeBug.php?BugUserName=$BugUserName\&BugUserPWD=$BugUserPWD