#!/bin/bash
# Shell to mail statistics of the BugFree system.
# 
...
# @package     BugFree
# @version     $Id: StatBug.sh,v 1.2 2005/09/01 02:16:11 wwccss Exp $
#
ServerName="http://wangcs2005.okooo.com"
BugUserName="wangcs"
BugUserPWD="123456"
wget --spider $ServerName/BugFree/StatBug.php?BugUserName=$BugUserName\&BugUserPWD=$BugUserPWD